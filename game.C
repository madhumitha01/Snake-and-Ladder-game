...
outtextxy(114,168,"LADDER");
   ...
   outtextxy(200,600,"https://github.com/madhumitha01");
   settextstyle(2,0,0);
   outtextxy(280,259,"MADHUMITHA RAJINIKANTHAN");
...
setfillstyle(1,12);
   ...
   outtextxy(116,169,"MADHUMITHA RAJINIKANTHAN");
   setcolor(2);
   outtextxy(116,179,"Computer Science Engineering");
   outtextxy(116,199,"NEW HORIZON COLLEGE OF ENGINEERING");
